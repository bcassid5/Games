...
public class Main : MonoBehaviour {
	...
	void Start () {
		...
		paper = paper.GetComponent<Button> ();
		scissors = scissors.GetComponent<Button> ();

		//get text
		player = player.GetComponent<Text> ();
		comp = comp.GetComponent<Text> ();
		winnerLine = winnerLine.GetComponent<Text> ();
		...
		playAgain = playAgain.GetComponent<Canvas> ();
